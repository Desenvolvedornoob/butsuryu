-- Adicionar textos em japonês para os cards do dashboard
-- Este script adiciona as traduções japonesas para todos os cards do dashboard

-- Inserir textos dos cards do dashboard em japonês
