-- LIMPEZA FORÇADA FINAL - RESOLVE QUALQUER PROBLEMA PERSISTENTE
-- Execute este script para forçar a limpeza completa e definitiva
...
-- Remover TODAS as políticas possíveis (incluindo nomes genéricos)
...
-- Remover políticas com nomes padrão do Supabase
DROP POLICY IF EXISTS "Users can view own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can update own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can insert own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can delete own profile" ON public.profiles;

-- Remover políticas com nomes em português
...
-- Se ainda existirem políticas, mostrar detalhes
SELECT 
